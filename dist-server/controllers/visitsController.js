 ...
 */
export const getVisitsStats = (req, res) => {
    try {
 ...
 */
export const getBasicVisitsStats = (req, res) => {
    try {
        const visitsData = getVisitsData();
        res.status(200).json({
 ...
 */
export const getPageVisitsStats = (req, res) => {
    try {
        const visitsData = getVisitsData();
 ...
 */
export const getTimeVisitsStats = (req, res) => {
    try {
        const visitsData = getVisitsData();
        res.status(200).json({
 ...
 */
export const getTechVisitsStats = (req, res) => {
    try {
        const visitsData = getVisitsData();
        res.status(200).json({
 ...
 */
export const getGeoVisitsStats = (req, res) => {
    try {
        const visitsData = getVisitsData();
...
export const generateTestData = (req, res) => {
    try {
        ...
        const simulateRequest = (path, country, userAgent) => {
            const mockReq = {
                path,
